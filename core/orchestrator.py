...
class Orchestrator:
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            "character": gs.character.name or "",
            "level": gs.character.level or 0,
            "map_id": gs.map.map_id,
            "map_x": gs.map.x,
            "map_y": gs.map.y,
            "cell_id": gs.character.cell_id,
            "hp": gs.stats.hp or 0,
            "max_hp": gs.stats.max_hp or 0,
            "mp": gs.stats.mp or 0,
            "max_mp": gs.stats.max_mp or 0,
            "ap": gs.stats.ap or 0,
            "max_ap": gs.stats.max_ap or 0,
            "kamas": gs.stats.kamas or 0,
            "in_fight": gs.in_fight,
            "is_busy": gs.is_busy,
            "busy_reason": gs.busy_reason or "",
